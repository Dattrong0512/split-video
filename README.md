...
Pipeline dùng Whisper nhận dạng lời nói rồi để Gemini sửa transcript và viết lại tiếng Việt theo nguyên timestamp từng cue; OCR chỉ phục vụ tìm vùng blur. Với một giọng, Gemini không nhận trường speaker/gender và mọi cue bị khóa vào cùng vai `S1`. Với 2–4 giọng, Gemini phải dùng đúng số vai đã chọn và giữ cùng mã cho cùng nhân vật/góc nhìn. Render từ chối cấu hình thừa, thiếu hoặc trùng giọng. Nhịp TTS được fit về thời lượng câu gốc trong khoảng tự nhiên 0,90–1,15×. Audio xuất chỉ giữ `no_vocals` từ Demucs cùng giọng Việt; vocal gốc không còn được trộn lại. Nếu Demucs thất bại, pipeline dùng nền im lặng thay vì đưa giọng gốc trở lại.
